...
const vec3 LIME   = vec3(0.0, 1.0, 1.0);
...
{		
	...
	// sphere1
	spheres[0].Center = vec3(2.0,-2.0,-3.0);//vec3(2.0,0.0,0.0);
	spheres[0].Radius = 2.0;
	spheres[0].MaterialIdx = 5;

	// sphere2
	spheres[1].Center = vec3(-3.0,-2.0,-1.0);//vec3(-2.0,1.0,-5.0);
	spheres[1].Radius = 1.0;
	spheres[1].MaterialIdx = 0;	

	spheres[2].Center = vec3(0.0,1.0,2.0);//vec3(2.0,0.0,0.0);
